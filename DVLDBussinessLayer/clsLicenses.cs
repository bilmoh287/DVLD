...
namespace DVLDBussinessLayer
{
    public class clsLicenses
    {
        ...
        public clsApplication ApplyForRenewal(string imagePath, int createdByUserID)
        {
            clsApplication _Application = new clsApplication();
            _Application.ApplicationTypeID = (int)clsApplication.enApplicationType.RenewDrivingLicense;
            _Application.ApplicantPersonID = this.DriverInfo.PersonInfo.PersonID;
        ...
        public clsApplication ApplyForReplacementDamaged(string imagePath, int createdByUserID)
        {
            clsApplication _Application = new clsApplication();
        ...
        public clsLicenses CompleteRenewalAfterPayment(clsApplication _Application, string Notes, int CreatedByUserID)
        {
            _Application.ApplicationStatus = clsApplication.enApplicationStatus.Completed;
            _Application.PaidFees = clsApplicationTypes.FindApplicationType((int)clsApplication.enApplicationType.RenewDrivingLicense).ApplicationTypeFees;
            _Application.LastStatusDate = DateTime.Now;
        ...
        public clsLicenses CompleteReplacementDamagedAfterPayment(clsApplication _Application, int CreatedByUserID)
        {
            _Application.ApplicationStatus = clsApplication.enApplicationStatus.Completed;
            _Application.PaidFees = clsApplicationTypes.FindApplicationType((int)clsApplication.enApplicationType.ReplaceDamagedDrivingLicense).ApplicationTypeFees;
            _Application.LastStatusDate = DateTime.Now;
            _Application.Save();
            ...
            try
            {
                clsUserMessage.SendSystemMessage(this.DriverInfo.PersonInfo.PersonID, "License Replaced", 
                    $"Your driving license (Class: {this.LicenseClassInfo.ClassName}) has been replaced due to being Damaged.", "License");
            }
            catch (Exception) { }
