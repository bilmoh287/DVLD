...
using DVLDPresentationLayer.Schools_Dashboard.Forms;

namespace DVLDPresentationLayer
{
    public partial class frmSchoolDashboard : Form
    {
        //Fields
        ...
        {
            //ActivateButton(sender);
            OpenChildForm(new frmStudents(), sender);
        }
        ...
        {
            frmTakeAttendance frm = new frmTakeAttendance(1);
            frm.ShowDialog();
        }
    }
}
