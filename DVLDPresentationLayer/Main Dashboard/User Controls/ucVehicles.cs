...
{
    public class ucVehicles : UserControl
    {
        public ucVehicles()
        {
        ...
        private void _Build()
        {
            ...
            {
                Text = "View driver records and their registered vehicle ownership history.",
            ...
            {
                ("List Drivers", "Browse all registered drivers in the system.", "🚗", () => { new frmListDrivers().ShowDialog(); }),
            };
